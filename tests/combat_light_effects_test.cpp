...
int main(){try{
 ...
 check(light.sample(220).size()==mgo2mt::maximum_dynamic_lights,"bounded pool");
 ...
 std::istringstream emptyText("MGO2MT.STAGE_COLLISION 1 0 0\n");auto world=std::make_shared<const mgo2mt::stage::Collision>(mgo2mt::stage::Collision::read(emptyText));
