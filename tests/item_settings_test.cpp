...
constexpr auto base="MGO2MT_ITEM_SETTINGS 1\ncapacity 64 64\nrecover_others 1\n";
...
int main(){std::filesystem::path directory;try{
 ...
 directory=std::filesystem::temp_directory_path()/(L"mgo2mt-item-settings-test-"+std::to_wstring(GetCurrentProcessId())+L"-"+std::to_wstring(GetTickCount64()));check(std::filesystem::create_directory(directory),"create isolated directory");const auto path=directory/L"設定.cfg";
