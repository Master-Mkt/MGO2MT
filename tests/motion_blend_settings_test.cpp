...
int main(){try{
 ...
 for(auto text:{"", "MGO2WIN.MOTION_BLEND 1 0\n", "MGO2WIN.MOTION_BLEND 1 9\n", "MGO2WIN.MOTION_BLEND 1 2001\n",
  "MGO2WIN.MOTION_BLEND 1 0500\n", "MGO2WIN.MOTION_BLEND 1 +500\n", "MGO2WIN.MOTION_BLEND 1 -500\n",
  "MGO2WIN.MOTION_BLEND 1 500.0\n", "MGO2WIN.MOTION_BLEND 1 500%\n", "MGO2WIN.MOTION_BLEND 1 off\n",
  "MGO2WIN.MOTION_BLEND 2 500\n", "MGO2WIN.MOTION_BLEND 1 500", "MGO2WIN.MOTION_BLEND 1 500\r\n",
  "MGO2WIN.MOTION_BLEND 1  500\n", "MGO2WIN.MOTION_BLEND 1 500 \n", "MGO2WIN.MOTION_BLEND 1 500\nextra\n",
  "MGO2WIN.MOTION_BLEND 1 42949672960\n"})check(!decode(text),"strict cfg rejects malformed/noncanonical/off values");
 ...
 const auto dir=std::filesystem::temp_directory_path()/(L"mgo2win-blend-settings-"+std::to_wstring(GetCurrentProcessId())+L"-"+std::to_wstring(GetTickCount64()));
 ...
 {std::ofstream file(path,std::ios::binary|std::ios::trunc);file<<"MGO2WIN.MOTION_BLEND 1 0\n";}
