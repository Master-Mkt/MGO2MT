...
int main(){try{
 ...
 std::vector<stage::CollisionTriangle> triangles{{{0,1,2}},{{0,2,3}},{{4,5,6}},{{4,6,7}}};triangles[2].attribute=triangles[3].attribute=0x40048000;
 ...
 auto wall=stage::Collision::make({{-10000,0,-1500},{10000,0,-1500},{10000,10000,-1500},{-10000,10000,-1500}},{{{0,1,2}},{{0,2,3}}});std::fill(pixels.begin(),pixels.end(),0);stage::paint_water(pixels,1280,720,lines,eye,direction,*moving,&wall);check(std::all_of(pixels.begin(),pixels.end(),[](auto p){return p==0;}),"wall occludes water effects");
