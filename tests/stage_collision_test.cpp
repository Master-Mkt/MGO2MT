...
int main(int argc,char**argv){try{
 std::istringstream in("MGO2MT.STAGE_COLLISION 1 3 1\n-2 0 -2\n2 0 -2\n0 0 2\n0 1 2 8192 7\n");auto c=Collision::read(in);
 ...
 for(auto s:{"MGO2MT.STAGE_COLLISION 1 500001 0","MGO2MT.STAGE_COLLISION 1 0 1 0 0 0 0 0","MGO2MT.STAGE_COLLISION 1 0 0 trailing"}){bool rejected=false;try{std::istringstream bad(s);Collision::read(bad);}catch(...){rejected=true;}check(rejected);}
