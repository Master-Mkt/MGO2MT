...
std::shared_ptr<const stage::Collision> scene(uint32_t material,uint64_t attributes=stage::attribute::native_solid){
 ...
 std::vector<stage::CollisionTriangle> triangles{{{0,1,2},stage::attribute::native_solid},{{0,2,3},stage::attribute::native_solid},{{4,6,5},attributes,0,0,0},{{4,7,6},attributes,0,0,0}};
...
int main(int argc,char**argv){try{
 ...
 for(uint8_t map:{1,4,20,21})for(uint32_t material:{0x48c4b8u,0x189cd4u,0xabcdefu}){
  ...
  auto blocker=stage::Collision::make({{-10000,0,750},{10000,0,750},{10000,5000,750},{-10000,5000,750}},{{{0,1,2},stage::attribute::native_solid},{{0,2,3},stage::attribute::native_solid}});
 ...
 // visible. Endpoint-only visibility would paint over the post.
 {
  ...
  auto post=stage::Collision::make({{-10,1500,750},{10,1500,750},{10,1600,750},{-10,1600,750}},{{{0,1,2},stage::attribute::native_solid},{{0,2,3},stage::attribute::native_solid}});
 ...
 {
  auto world=stage::Collision::make({{-10000,0,-10000},{10000,0,-10000},{10000,0,10000},{-10000,0,10000}},{{{0,1,2},stage::attribute::native_solid},{{0,2,3},stage::attribute::native_solid}});
  auto post=stage::Collision::make({{-15,1500,500},{15,1500,500},{15,1600,500},{-15,1600,500}},{{{0,1,2},stage::attribute::native_solid},{{0,2,3},stage::attribute::native_solid}});
