...
int main(int argc,char**argv){try{
 ...
 for(auto text:{"", "MGO2WIN.STAGE_LIGHTS 1 4097", "MGO2WIN.STAGE_LIGHTS 2 0"}){std::istringstream in(text);bool rejected=false;try{Lighting::read(in);}catch(...){rejected=true;}check(rejected,"bad native lighting rejected");}
