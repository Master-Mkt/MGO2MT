...
std::string encode(const Settings& settings){
 ...
 return "MGO2MT.MOTION_BLEND 1 "+std::to_string(settings.percentPerSecond)+'\n';
}
std::optional<Settings> decode(std::string_view text)noexcept{
 const std::string_view prefix=text.starts_with("MGO2WIN.MOTION_BLEND 1 ")?"MGO2WIN.MOTION_BLEND 1 ":"MGO2MT.MOTION_BLEND 1 ";
