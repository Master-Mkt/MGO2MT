...
class PlayerMenu {
 ...
 std::shared_ptr<GraphicsSettings> graphics_;std::wstring chat_,notice_;
 ...
 std::shared_ptr<items::ClientSession> inventorySession_;items::ClientState inventoryState_;unsigned inventoryFocus_=0;void inventory_action();
...
public:
 ...
 bool visible()const{return kind_!=player::Menu::none;}
